...
public class TestSimpleHashMap {
	...
	public final void testDuplicates() {
		...
		assertEquals("wrong size():", 2, m16.size()); 
		//Those motherfuckers... Size är inte bara vektorn element, utan totala mängden. Kör vectorSize och 
		// totalSize. DE VILL HA TOTALSIZE när de frågar efter size. Överallt där du skrivit size, skriv
		//vectorSize....
