...
public class Dialogs {
	 ...
	 * @param title the title of the pop up window
	 * @param headerText the string to show in the dialog header area
	 * @param labels the string to show in the dialog content area before the input field
	 * @return An Optional that contains the result
	 */
	public static Optional<String> oneInputDialog(String title, String headerText, String labels) {
		TextInputDialog dialog = new TextInputDialog();
		dialog.setTitle(title);
		dialog.setHeaderText(headerText);
		dialog.setContentText(labels + ": ");
